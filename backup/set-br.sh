...
echo "Checking VPS"
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/awanbebas/vpn2/main/backup"
...
wget -O limitspeed "https://raw.githubusercontent.com/awanbebas/vpn2/main/backup/limitspeed.sh"
chmod +x autobackup
chmod +x backup
chmod +x restore
chmod +x strt
