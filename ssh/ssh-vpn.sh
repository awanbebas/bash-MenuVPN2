...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/awanbebas/vpn1/main/issue.net"
...
wget -O up "https://raw.githubusercontent.com/awanbebas/vpn1/main/up.sh"
chmod +x menu
chmod +x menu-trial
chmod +x menu-vmess
chmod +x menu-vless
