...
sleep 2
clear
wget https://raw.githubusercontent.com/awanbebas/vpn1/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/awanbebas/vpn1/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/awanbebas/Bless/main/Tunnel/udp.sh && bash udp.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
